...
export default function GPayEditor() {
  ...
  const [data, setData] = useState<any>({
    ...
    toUpi: "",
    fromName: "Your Banking Name (State Bank of India)",
    fromUpi: "yourupiid@oksbi",
  });
    ...
    <div className="min-h-screen w-full grid grid-cols-1 md:grid-cols-2 p-6 gap-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          <Label htmlFor="scanner" className="text-sm">Upload Scanner</Label>
          <Input
          id="scanner"
            type="file"
            accept="image/*"
            ...
            onChange={handleFile}
          />
          <p className="text-xs text-neutral-700">* This is to get the receiver&apos; UPI ID and Reciever&apos; Name</p>
          <p className="text-xs text-neutral-700">* If no scanner, enter receiver&apos; upi id and name manually</p>
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          />
          <p className="text-xs text-neutral-700">* You can change the bank name. Add a 4-digit numerical code after the name</p>
          </div>
